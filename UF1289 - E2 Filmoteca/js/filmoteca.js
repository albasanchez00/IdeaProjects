...
filmoteca={
    ...
    agregarPelicula:function(image,nombre,descripcion,genero,anioEstreno) {
        if(!image || !nombre || !descripcion || !genero || !anioEstreno){
            console.log("Todos los campos son obligatorios");
            return;
        }
        this.agregarPelicula.push(image,nombre,descripcion,genero,anioEstreno);
